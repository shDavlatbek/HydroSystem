...
from .models import Well, Coordinate, WaterLevel
...
class PasportForm(forms.ModelForm):
    ...
    class Meta:
        model = Well
        fields = [
            'organization', 'well_number', 'expedicion', 'type', 'region', 'district', 'address', 'location', 'created_at',
        ...
        widgets = {
            ...
            'expedicion': forms.Select(attrs={'class': 'form-control expedicion_select', 'required':'required'}),
